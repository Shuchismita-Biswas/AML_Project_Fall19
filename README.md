...
This produces angular values in the range [0, π], which is later used in calculating information granularity in the GAF. The next step involves the calculation of cosine angle (ϕ) and the radius,<img src="https://latex.codecogs.com/svg.latex?\Large&space;r}"/>, from the time stamp, <img src="https://latex.codecogs.com/svg.latex?\Large&space;t}"/>, as:<img src="https://tex.s2cms.ru/svg/%5Cphi%3Dcos%5E%7B-1%7D(x'_i)%2C%20%5Cquad%20-1%5Cleq%20x'_i%20%5Cleq%201%20" alt="\phi=cos^{-1}(x'_i), \quad -1\leq x'_i \leq 1 " />
